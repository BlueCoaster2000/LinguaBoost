...
<body>
    ...
    <h1 class="text-center">Curso De Español Nivel 0</h1>
    <main>
        ...
        <div class="area_ejercicios col-12">
            <div id="ejercicio1">
                ...
                <button id="btn1" onclick="validarPregunta('manzana','manzana','ejercicio1')">
                    <img src="../images/apple.png" class="image_ej" alt="manaza" />Manzana</button>

                <button id="btn2" onclick="validarPregunta('limon','manzana','ejercicio1')">
                    <img src="../images/lemon.png" class="image_ej" alt="Lemon" />Lemon</button>

                <button id="btn3" onclick="validarPregunta('sandia','manzana','ejercicio1')">
            ...
            <div id="ejercicio2" style="display: none;">
                ...
                <input type="text" name="limon" id="limon_ej2">
                <button class="btn btn-warning" onclick="validarPreguntaInput('limon','limon_ej2','ejercicio2')">
                    Comprobar Resultado
                </button>
                <p id="palabra"></p>
            ...
            <div id="ejercicio3" style="display:none;">
                ...
                <button class="btn btn-primary" onclick="playAudio('../images/exercises/sandia.mp3')">
                ...
                <button onclick="validarPregunta('manzana','sandia','ejercicio3')">
                    <img src="../images/apple.png" class="image_ej" alt="Apple" /></button>

                <button onclick="validarPregunta('limon','sandia','ejercicio3')">
                    <img src="../images/lemon.png" class="image_ej" alt="Lemon" /></button>

                <button onclick="validarPregunta('sandia','sandia','ejercicio3')">
                    <img src="../images/watermelon.png" class="image_ej" alt="Watermelon" />
                </button>
